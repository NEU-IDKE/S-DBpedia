...
path = "../openke-data/benchmarks/S-DBpedia_small/"
...
trainer.run()
transe_gdr.save_checkpoint(log_path + 'transe_gdr-S-DBpedia_small.ckpt')

# test the model
transe_gdr.load_checkpoint(log_path + 'transe_gdr-S-DBpedia_small.ckpt')
