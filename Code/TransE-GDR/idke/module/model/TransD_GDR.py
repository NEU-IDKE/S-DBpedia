...
class TransD_GDR(Model):

    def __init__(self, ent_tot, rel_tot, dim_e = 100, dim_r = 100, p_norm = 1, norm_flag = True, margin = None, epsilon = None, in_path = './', use_gpu = True):
        super(TransD_GDR, self).__init__(ent_tot, rel_tot)
